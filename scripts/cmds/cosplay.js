...
module.exports = {
  config: {
    name: "cosplay",
    version: "1.0.0",
    author: "MAVERICK (converted to got)",
    description: "Gửi ngẫu nhiên ảnh gái cosplay",
    category: "box chat",        // có thể đổi thành "Nhóm" nếu bot bạn phân loại như vậy
    cooldown: 5
  },

  onStart: async function ({ api, event }) {
    // Danh sách link ảnh cosplay
    const link = [
    ...
    const imgPath = __dirname + "/cache/49.jpg";
    ...
    try {
      ...
      api.sendMessage(
        {
          body: `Ảnh Cosplay Việt Nam\nTổng số ảnh: ${link.length}`,
      ...
      console.error(error);
      api.sendMessage("Không thể tải ảnh, vui lòng thử lại.", event.threadID);
    }
  }
};