...
module.exports = {
  config: {
    name: "gái",                 // tên lệnh
    version: "1.0.1",
    author: "Raiden Ei • convert by GPT",
    description: "Gửi ngẫu nhiên ảnh girl xinh",
    category: "Tiện ích", 
    cooldown: 2
  },
  ...
  onStart: async function ({ api, event }) {
    ...
    try {
      ...
      api.sendMessage(
        { body: "Gái xinh đây 😍", attachment: fs.createReadStream(imgPath) },
        event.threadID,
        () => fs.unlinkSync(imgPath)
      );
    } catch (e) {
      console.error(e);
      api.sendMessage("Không thể tải ảnh, thử lại sau.", event.threadID);
    }
  }
};